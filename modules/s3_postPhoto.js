...
const uploadImage = multer({
  storage: multerS3({
    ...
    key: (req, file, callback) => {
      ...
      const postPhoto = `https://outstagrams.s3.ap-northeast-2.amazonaws.com/postPhoto/${date}_${randomNumber}`;
      req.postPhoto = postPhoto;

      callback(null, `postPhoto/${date}_${randomNumber}`);
    },
    acl: "public-read",
  }),
  limits: {
